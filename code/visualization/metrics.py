...
METRICS: Dict[str, Metric] = {
    ...
    "tval": Metric(
        ...
        value_key="tvals",
        # Canonical (current) keys first, legacy keys (old stats files) last.
        pval_keys=["pvals_tmax", "pvals_fdr_bh", "pvals_bonferroni",
                   "pvals_uncorrected",
                   "pvals_corrected_tmax", "pvals_corrected_fdr_bh",
                   "pvals_corrected_fdr", "pvals_corrected_bonferroni",
                   "pvals"],
